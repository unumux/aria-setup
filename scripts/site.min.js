...
"use strict";var $=require("jquery"),burger=document.querySelector(".main-nav--icon"),nav=document.querySelector(".main-nav");burger.addEventListener("click",function(){nav.classList.contains("hidden")?nav.classList.remove("hidden"):nav.classList.add("hidden")}),window.addEventListener("load",function(){console.log("it worksssss"),$(window).width()>700?(burger.classList.add("hidden"),nav.classList.remove("hidden")):$(window).width()<700&&(burger.classList.remove("hidden"),nav.classList.add("hidden"))}),window.addEventListener("resize",function(){console.log("it worksssss"),$(window).width()>700?(burger.classList.add("hidden"),nav.classList.remove("hidden")):$(window).width()<700&&(burger.classList.remove("hidden"),nav.classList.add("hidden"))});
},{"jquery":1}]},{},[2])
