...
"use strict";var $=require("jquery");$("html").click(function(){var r=Math.round(255*Math.random()),a=Math.round(255*Math.random()),t=Math.round(255*Math.random()),o=Math.random();$("html").css("background-color","rgba("+r+", "+a+", "+t+", "+o+")")});
},{"jquery":1}]},{},[2])
